...
<Note title="In Development" type="warning">
	This plugin is still in the early stages of the development and may contain many
	bugs or lack some functionality. Using in production is not recommended.
</Note>
